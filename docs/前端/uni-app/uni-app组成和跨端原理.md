...
在app端，还支持原生渲染的[nvue](https://uniapp.dcloud.net.cn/tutorial/nvue-outline)，以及可以编译为kotlin和swift的[uts](https://doc.dcloud.net.cn/uni-app-x/uts/)。
...
更多编译器介绍参见：[编译器](https://uniapp.dcloud.net.cn/tutorial/compiler)
